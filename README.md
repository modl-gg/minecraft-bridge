modl minecraft bridge
-
anti-cheat hook, stat-wiping, other spigot-required features
...
### Stat-wiping
Configure commands to be executed when a punishment naturally expires (if stat-wiping is enabled on that punishment).
